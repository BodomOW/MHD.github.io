...
<div class="containerPortf">
    ...
    <div class="element">
        <a href="img/portf/BP01.jpg" data-lightbox="mygallery" data-title="ASDFASDF">
            <img src="img/portf/BP01.jpg">
        </a>
    </div>
    <div class="element">
        <a href="img/portf/BP02.jpg" data-lightbox="mygallery" data-title="ASDFASDF">
            <img src="img/portf/BP02.jpg">
        </a>
    </div>
    <div class="element">
        <a href="img/portf/BP03.jpg" data-lightbox="mygallery" data-title="ASDFASDF">
            <img src="img/portf/BP03.jpg">
        </a>
    </div>
...
<div style="width: 100%; display: flex; align-items: center; justify-content: center;">
            <div style="width: 50%; text-align: justify; text-justify: inter-word; color: #00124B; font-size: 20px; margin: 30px;">
                <b>2019. Beta Procesos (Celaya, Guanajuato. México) - </b>Diseño de publicidad digital para redes sociales.
                <p>
                    <b>Facebook: </b><a href="https://www.facebook.com/BetaProcesos" target="_blank">https://www.facebook.com/BetaProcesos</a>
                </p>
            </div>
    </div>
